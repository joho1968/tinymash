...
class AdminController extends BaseController {
    ...
    public function handleContentBatchAction() : void {
        ...
        try {
            ...
            if ( $tab === 'drafts' ) {
                ...
                if ( $action === 'delete' ) {
                    $count = $this->content_repository->deleteEntriesByIds( $ids, $author_slug, $allow_root );
    ...
    protected function normalizeContentBatchTab( string $tab ) : string {
        ...
        return( in_array( $tab, [ 'entries', 'drafts', 'moderation' ], true ) ? $tab : 'entries' );
    }
    ...
    protected function getContentBatchSuccessMessage( string $tab, string $action, int $count ) : string {
        ...
        return( 'Deleted ' . $count . ' ' . $item_label . '.' );
    }
